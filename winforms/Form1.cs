...
namespace RadialControllerWinForms
{
    public partial class Form1 : Form
    {
        ...
        //Event Handler and Callback definition
        ...
        // Add Custom Items to Surface Dial Menu
        private void AddCustomItems()
        {
            AddItemFromKnownIcon();
            AddItemFromImage();
            AddItemsFromFont();
        }

        private void AddItemFromKnownIcon()
        {
            radialController.Menu.Items.Add(RadialControllerMenuItem.CreateFromKnownIcon("InkColor", RadialControllerMenuKnownIcon.InkColor));
        }

        //Add Item to Surface Dial. Icon create from Font Letter 
        private void AddItemsFromFont()
        {
            // Using custom font
            //string fontFilePath = GetSharedFilePath("Symbols.ttf");
            string fontFilePath = GetFilePath("Symbols.ttf");
        ...
        //Add Item to Surface Dial. Icon create from Image file 
        ...
        //Set Default menu item to Surface Dial
